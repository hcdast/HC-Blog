...
function itemClick() {
    var id = window.location.pathname.slice(11, 25);
    $.ajax({
        type: "get",
        url: "/api/life/itemclick",
        dataType: "json",
        data: {
            id: id
        },
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.statu == "success") {
                ...
                $(".info .type").append("【" + lifeType[parseInt(data.type)] + "】");
