...
function itemClick() {
    var id = window.location.pathname.slice(14, 28);
    $.ajax({
        type: "get",
        url: "/api/article/itemclick",
        dataType: "json",
        data: {
            id: id
        },
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.statu == "success") {
                ...
                $(".info .type").append("【" + articleType[parseInt(data.type)] + "】");
